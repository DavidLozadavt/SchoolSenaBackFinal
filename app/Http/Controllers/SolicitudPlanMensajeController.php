...
class SolicitudPlanMensajeController extends Controller
{
    ...
    // -------------------------------------------------------------------------
    // HISTORIAL DE FACTURACI�N (Administrador VT)
    //
    // Fusionado aqu� desde el antiguo HistorialFacturacionController y su
    // servicio: mismo dominio (solicitudes de planes). SOLO LECTURA por JOINs
    // sobre tablas existentes; no crea tablas ni duplica informaci�n.
    // -------------------------------------------------------------------------
