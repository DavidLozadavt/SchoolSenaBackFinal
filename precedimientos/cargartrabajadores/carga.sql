CREATE  PROCEDURE `vt_school_on`.`cargarTrabajadores`(
	IN companyId INT,
	IN val_centroId INT,
    ...
    read_loop: LOOP
        ...
        IF RESULT = 0 THEN
            ...
            IF NOT EXISTS (
                SELECT 1
                FROM nivelEducativo
                WHERE nombreNivel COLLATE utf8mb4_unicode_ci = nivelEdu COLLATE utf8mb4_unicode_ci
            ) THEN
		   ...
		   'NORMAL',                     
            ...
            -- 11. Asignar Área de Conocimiento al Contrato
